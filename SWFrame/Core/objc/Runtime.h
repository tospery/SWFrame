    ...
    IMP (^originalIMPProvider)(void) = ^IMP(void) {
        ...
        if (!result) {
            result = imp_implementationWithBlock(^(id selfObject){
                NSLog(@"【%@】%@ 没有初始实现，%@\n%@", ([NSString stringWithFormat:@"%@", targetClass]), NSStringFromSelector(targetSelector), selfObject, [NSThread callStackSymbols]);
            });
        }
...
CG_INLINE BOOL
ExtendImplementationOfUIViewMethodWithCGRectArgument(Class targetClass, SEL targetSelector, UIView * (^implementationBlock)(__kindof UIView *selfObject, CGRect frame, UIView *originReturnValue)) {
    return OverrideImplementation(targetClass, targetSelector, ^id(__unsafe_unretained Class originClass, SEL originCMD, IMP (^originalIMPProvider)(void)) {
        return ^UIView * (__unsafe_unretained __kindof NSObject *selfObject, CGRect firstArgv) {
            ...
            return implementationBlock(selfObject, firstArgv, result);
        };
    });
}
 ...
 */
#define _SWFTypeEncodingDetectorGenerator(_TypeInFunctionName, _typeForEncode) \
...
_SWFTypeEncodingDetectorGenerator(Char, char)
_SWFTypeEncodingDetectorGenerator(Int, int)
_SWFTypeEncodingDetectorGenerator(Short, short)
_SWFTypeEncodingDetectorGenerator(Long, long)
_SWFTypeEncodingDetectorGenerator(LongLong, long long)
_SWFTypeEncodingDetectorGenerator(NSInteger, NSInteger)
_SWFTypeEncodingDetectorGenerator(UnsignedChar, unsigned char)
_SWFTypeEncodingDetectorGenerator(UnsignedInt, unsigned int)
_SWFTypeEncodingDetectorGenerator(UnsignedShort, unsigned short)
_SWFTypeEncodingDetectorGenerator(UnsignedLong, unsigned long)
_SWFTypeEncodingDetectorGenerator(UnsignedLongLong, unsigned long long)
_SWFTypeEncodingDetectorGenerator(NSUInteger, NSUInteger)
_SWFTypeEncodingDetectorGenerator(Float, float)
_SWFTypeEncodingDetectorGenerator(Double, double)
_SWFTypeEncodingDetectorGenerator(CGFloat, CGFloat)
_SWFTypeEncodingDetectorGenerator(BOOL, BOOL)
_SWFTypeEncodingDetectorGenerator(Void, void)
_SWFTypeEncodingDetectorGenerator(Character, char *)
_SWFTypeEncodingDetectorGenerator(Object, id)
_SWFTypeEncodingDetectorGenerator(Class, Class)
_SWFTypeEncodingDetectorGenerator(Selector, SEL)
...
#define _SWFGetIvarValueGenerator(_TypeInFunctionName, _typeForEncode) \
...
_SWFGetIvarValueGenerator(Char, char)
_SWFGetIvarValueGenerator(Int, int)
_SWFGetIvarValueGenerator(Short, short)
_SWFGetIvarValueGenerator(Long, long)
_SWFGetIvarValueGenerator(LongLong, long long)
_SWFGetIvarValueGenerator(UnsignedChar, unsigned char)
_SWFGetIvarValueGenerator(UnsignedInt, unsigned int)
_SWFGetIvarValueGenerator(UnsignedShort, unsigned short)
_SWFGetIvarValueGenerator(UnsignedLong, unsigned long)
_SWFGetIvarValueGenerator(UnsignedLongLong, unsigned long long)
_SWFGetIvarValueGenerator(Float, float)
_SWFGetIvarValueGenerator(Double, double)
_SWFGetIvarValueGenerator(BOOL, BOOL)
_SWFGetIvarValueGenerator(Character, char *)
_SWFGetIvarValueGenerator(Selector, SEL)
