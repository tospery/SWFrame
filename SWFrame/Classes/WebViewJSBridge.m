...
- (void)send:(id)data responseCallback:(WVJSBResponseCallback)responseCallback {
...
- (void)disableJSAlertBoxSafetyTimeout {
    [_base disableJSAlertBoxSafetyTimeout];
}
...
- (void)WKFlushMessageQueue {
    [_webView evaluateJavaScript:[_base webViewJSFetchQueyCommand] completionHandler:^(NSString* result, NSError* error) {
        if (error != nil) {
...
- (void)webView:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler {
    ...
    if ([_base isWebViewJSBridgeURL:url]) {
