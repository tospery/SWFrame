...
public final class MoyaLoggerPlugin {

    public var configuration: Configuration

    /// Initializes a MoyaLoggerPlugin.
...
// MARK: - PluginType
extension MoyaLoggerPlugin: PluginType {
...
// MARK: - Configuration
public extension MoyaLoggerPlugin {
...
public extension MoyaLoggerPlugin.Configuration {
...
public extension MoyaLoggerPlugin {
    ...
    class var `default`: MoyaLoggerPlugin {
        return MoyaLoggerPlugin(configuration: Configuration(logOptions: .default))
    }

    /// Returns the default verbose logger plugin
    class var verbose: MoyaLoggerPlugin {
        return MoyaLoggerPlugin(configuration: Configuration(logOptions: .verbose))
    }
}
